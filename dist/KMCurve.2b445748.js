...
})({"lEgAk":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "8e0a43d22b445748";
"use strict";
...
},{}],"cfOBF":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$585f = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
$parcel$ReactRefreshHelpers$585f.init();
var prevRefreshReg = globalThis.$RefreshReg$;
var prevRefreshSig = globalThis.$RefreshSig$;
$parcel$ReactRefreshHelpers$585f.prelude(module);
...
class KMCurve extends (0, _react.PureComponent) {
    constructor(props){
        super(props);
    ...
    componentDidMount() {
        setTimeout(()=>{
            ...
            // create svg
            const svg = _d3.select(this.self.current).append('svg').attr('width', rect.width).attr('height', rect.height);
            // create viewer
            const viewer = svg.append('g').attr('transform', `translate(${this.state.margin.left},${this.state.margin.top})`);
            //
            this.xScale = _d3.scaleLinear().domain([
                0,
                this.maxTime
            ]).range([
                0,
            ...
            this.yScale = _d3.scaleLinear().domain([
                0,
                1
            ]).range([
                innerHeight,
            ...
            this.color = _d3.scaleOrdinal().domain(this.state.data.map((d)=>d.key)).range(_d3.quantize((t)=>_d3.interpolateSpectral(t), this.state.data.length));
            const xaxisGroup = viewer.append('g').attr('transform', `translate(0,${innerHeight})`).call(_d3.axisBottom(this.xScale).ticks(4)); // .tickSize(-innerWidth));
            ...
            // add the y Axis
            const yaxisGroup = viewer.append('g').call(_d3.axisLeft(this.yScale).ticks(4)); // .tickSize(-innerWidth)
    ...
    transform(data, field) {
        ...
        const filteredData = data.filter((d)=>d.collapsed_stage !== 'stage_x/NR' && !isUndefined(d[time]) && !isUndefined(d[event]) && !isUndefined(d[group]));
        this.maxTime = Math.max(...filteredData.map((d)=>d[time]));
        const groups = _d3.nest().key((d)=>d[group]).entries(filteredData);
        const rs = [];
        groups.forEach((g)=>{
            const { key } = g;
            let risk = g.values.length;
            const values = _d3.nest().key((d)=>+d[time]).sortKeys((a, b)=>+a - +b).rollup((v)=>({
    ...
    drawLine(viewer, points, color) {
        const line = _d3.line().curve(_d3.curveStepAfter).x((d)=>this.xScale(d.time)).y((d)=>this.yScale(d.p));
    ...
    render() {
        return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            ...
            fileName: "source/components/VisualTools/Chart/KMCurve.js",
            lineNumber: 211,
            columnNumber: 12
        }, this);
    }
...
KMCurve.propTypes = {
    ...
    fields: (0, _propTypesDefault.default).shape({
        ...
        time: (0, _propTypesDefault.default).shape()
    }).isRequired,
    filter: (0, _propTypesDefault.default).shape({
        field: (0, _propTypesDefault.default).string,
...
KMCurve.defaultProps = {
  ...
  $parcel$ReactRefreshHelpers$585f.postlude(module);
} finally {
  globalThis.$RefreshReg$ = prevRefreshReg;
  globalThis.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"dVPUn","react":"jMk1U","d3":"4vBCR","prop-types":"GNqOQ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi"}]},["lEgAk"], null, "parcelRequire06c0", {})

//# sourceMappingURL=KMCurve.2b445748.js.map
