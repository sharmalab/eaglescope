...
function (_PureComponent) {
  ...
  function ScatterChart(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ScatterChart).call(this, props));
    ...
    value: function componentDidMount() {
      ...
      setTimeout(function () {
        ...
        _this3.circles = viewer.selectAll("circle").data(_this3.state.data).enter().append("circle").attr("r", function (d) {
          return _this3.radiusScale(d[_this3.props.fields.z]);
        }).attr("cx", function (d) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40209" + '/');
