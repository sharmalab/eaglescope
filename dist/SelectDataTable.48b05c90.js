...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/VisualTools/VisDataTable/SelectDataTable.js":[function(require,module,exports) {
"use strict";
...
var SelectDataTable = exports.default = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(SelectDataTable, [{
    ...
    key: "getFileExt",
    value: function getFileExt(slide_url) {
      ...
      var lastPart = slide_url.substring(slide_url.lastIndexOf('/') + 1);
      ...
      try {
        var _loop2 = function _loop2() {
          ...
          fetch("/node/" + record + "?_format=json", {
            ...
            var collectionId = x['field_collection'][0]['target_id'];
            ...
            fetch("/taxonomy/term/" + collectionId + "?_format=json", {
              ...
              var collectionName = collectionDoc['name']['0']['value'];
              ...
              var filename = collectionName + "_" + subId + "_" + imageId + "." + _this2.getFileExt(slide_url);
...
//# sourceMappingURL=/SelectDataTable.48b05c90.js.map