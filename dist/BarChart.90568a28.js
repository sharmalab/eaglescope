...
},{"f11b6b8f6a1f6f0b":"786KC","f490fb404efab291":"1dldy"}],"iNGj0":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "fde1923190568a28";
"use strict";
...
},{}],"k15NU":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$d2de = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$d2de.prelude(module);
...
const wrap = (text, width)=>{
    text.each(function updateBars() {
        const currentText = _d3.select(this);
...
function BarChart(props) {
    ...
    const createXScale = (f, width)=>{
        // set the ranges
        const xScale = _d3.scaleBand().domain(fullData.map((d)=>d[f]).flat()).range([
            0,
            width
        ]).padding(0.1);
        return xScale;
    ...
    (0, _react.useEffect)(()=>{
        setTimeout(()=>{
            ...
            // create svg
            const svg = _d3.select(self.current).append('svg').attr('width', rect.width).attr('height', rect.height).attr('role', 'img');
            // create viewer
            ...
            viewerRef.current.append('g').attr('class', 'x axis').attr('transform', `translate(0,${innerHeight})`).call(xAxis).selectAll('.tick text').call(wrap, xScale.bandwidth());
            // add the y Axis
            const yAxis = _d3.axisLeft(yScale).tickSize(-innerWidth);
    ...
    (0, _react.useEffect)(()=>{
        setTimeout(()=>{
            let data = [];
            if (props.filters.length > 0) data = transform(props.filterData, props.fields.x, props.fields.isList);
            else data = fullData;
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        fileName: "source/components/VisualTools/Chart/BarChart.js",
        lineNumber: 215,
        columnNumber: 10
    }, this);
}
_s(BarChart, "VCMCnRdkXpyw+fIy5f0i9mK1XYQ=");
_c = BarChart;
...
$RefreshReg$(_c, "BarChart");
  ...
  $parcel$ReactRefreshHelpers$d2de.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","d3":"iUtZE","prop-types":"7wKI2","../../partials/tooltip":"3u0XM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"3u0XM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3 = require("d3");
/**
...
},{"d3":"iUtZE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aQL8O","iNGj0"], null, "parcelRequire94c2")

//# sourceMappingURL=BarChart.90568a28.js.map
