...
})({"gO9zU":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "66ace7fcab1e72c4";
"use strict";
...
},{}],"5kdWh":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$8a1c = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
$parcel$ReactRefreshHelpers$8a1c.init();
var prevRefreshReg = globalThis.$RefreshReg$;
var prevRefreshSig = globalThis.$RefreshSig$;
$parcel$ReactRefreshHelpers$8a1c.prelude(module);
...
const transform = (data, field, isList = false)=>{
    if (isList) return transformList(data, field);
    ...
    return _d3.nest().key((d)=>d[field]).sortKeys(collSort).rollup((v)=>v.length).entries(data);
};
function HorizontalBarChart(props) {
    ...
    const scaleRef = (0, _react.useRef)();
    const hightRef = (0, _react.useRef)();
    const viewerRef = (0, _react.useRef)();
    const createLogXScale = (f, width)=>{
        const maxValue = _d3.max(fullData, (d)=>d[f]);
        // for now, starting domain at 1 always.
        const xScale = _d3.scaleLog().domain([
            1,
            maxValue
        ]).range([
            0,
    ...
    const createXScale = (f, width)=>{
        const xScale = _d3.scaleLinear().domain([
            0,
            _d3.max(fullData, (d)=>d[f])
        ]).range([
            0,
            width
        ]);
    ...
    const createYScale = (f, height)=>{
        // set the ranges
        const yScale = _d3.scaleBand().domain(fullData.map((d)=>d[f])).range([
            height,
            0
        ]).padding(0.1);
        return yScale;
    ...
    (0, _react.useEffect)(()=>{
        setTimeout(()=>{
            ...
            let tickCount = 4;
            // create svg
            const svg = _d3.select(self.current).append('svg').attr('width', rect.width).attr('height', rect.height);
            // create viewer
            ...
            viewerRef.current.append('g').attr('transform', `translate(0,${innerHeight})`).call(_d3.axisBottom(xScale).tickSize(-innerHeight).tickValues(xScale.ticks(tickCount)).tickFormat(formatTick));
    ...
    (0, _react.useEffect)(()=>{
        setTimeout(()=>{
            let data = [];
            if (props.filters.length > 0) data = transform(props.filterData, props.fields.y, props.fields.isList);
            else data = fullData;
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        fileName: "source/components/VisualTools/Chart/HorizontalBarChart.js",
        lineNumber: 214,
        columnNumber: 10
    }, this);
}
_s(HorizontalBarChart, "VCMCnRdkXpyw+fIy5f0i9mK1XYQ=");
...
HorizontalBarChart.propTypes = {
    ...
    fields: (0, _propTypesDefault.default).shape({
        ...
        isList: (0, _propTypesDefault.default).bool
    }).isRequired,
    ...
    logScale: (0, _propTypesDefault.default).bool,
...
$RefreshReg$(_c, "HorizontalBarChart");
  ...
  $parcel$ReactRefreshHelpers$8a1c.postlude(module);
} finally {
  globalThis.$RefreshReg$ = prevRefreshReg;
  globalThis.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"dVPUn","react":"jMk1U","d3":"4vBCR","prop-types":"GNqOQ","../../partials/tooltip":"4DNZY","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi"}],"4DNZY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _d3 = require("d3");
/**
...
},{"d3":"4vBCR","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["gO9zU"], null, "parcelRequire06c0", {})

//# sourceMappingURL=HorizontalBarChart.ab1e72c4.js.map
