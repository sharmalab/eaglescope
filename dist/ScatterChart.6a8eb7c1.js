...
},{"f11b6b8f6a1f6f0b":"786KC","f490fb404efab291":"1dldy"}],"2SOlF":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "20149c5b6a8eb7c1";
"use strict";
...
},{}],"9jE52":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$6d3e = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$6d3e.prelude(module);
...
class ScatterChart extends (0, _react.PureComponent) {
    constructor(props){
        super(props);
        this.self = /*#__PURE__*/ (0, _reactDefault.default).createRef();
        this.state = {
            margin: {
                top: 5,
                right: 10,
    ...
    componentDidUpdate() {
        setTimeout(()=>{
            _d3.select(this.self.current).selectAll('canvas').remove('canvas');
            _d3.select(this.self.current).selectAll('svg').remove('svg');
            ...
            this.canvas = _d3.select(this.self.current).append('canvas').attr('width', innerWidth).attr('height', innerHeight).style('transform', `translate(${this.state.margin.left}px,${this.state.margin.top}px)`);
            // create svg
            const svg = _d3.select(this.self.current).append('svg').attr('width', this.rect.width).attr('height', this.rect.height).attr('transform', `translate(${0},${-innerHeight})`);
            // create viewer
            ...
            const getCurrentMouseClickPosition = ()=>{
                console.log(svg);
                const mouseX = _d3.event.sourceEvent.clientX - svg.node().getBoundingClientRect().x - this.state.margin.left;
                const mouseY = _d3.event.sourceEvent.clientY - svg.node().getBoundingClientRect().y;
                return [
                    mouseX,
                    mouseY
                ];
            };
            viewer.append('g').attr('transform', `translate(0,${innerHeight})`).call(_d3.axisBottom(this.xScale).tickSize(-innerHeight));
            // add the y Axis
            viewer.append('g').call(_d3.axisLeft(this.yScale).tickSize(-innerWidth));
            this.brush = _d3.brush().extent([
                [
                    0,
                    0
                ],
    ...
    createScaleLiner(f, range) {
        ...
        const domainExtent = _d3.extent(this.state.data, (d)=>d[f]);
        const domainPadding = (domainExtent[1] - domainExtent[0]) * paddingPercent;
        const scaleLiner = _d3.scaleLinear().domain([
        ...
        const filters = [
            {
                ...
                operation: 'range',
                values: [
                    (0, _utils.numFixed)(this.xScale.invert(x0)),
                    (0, _utils.numFixed)(this.xScale.invert(x1))
                ]
            },
            {
                id: `${this.props.id}_y`,
                ...
                operation: 'range',
                values: [
                    (0, _utils.numFixed)(this.yScale.invert(y1)),
                    (0, _utils.numFixed)(this.yScale.invert(y0))
                ]
            }
        ];
    ...
    render() {
        return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
            ...
            fileName: "source/components/VisualTools/Chart/ScatterChart.js",
            lineNumber: 202,
            columnNumber: 7
        }, this);
    }
...
ScatterChart.propTypes = {
    ...
    fields: (0, _propTypesDefault.default).shape({
        ...
        z: (0, _propTypesDefault.default).string
    }).isRequired,
  ...
  $parcel$ReactRefreshHelpers$6d3e.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","d3":"iUtZE","prop-types":"7wKI2","../../../common/utils":"rzfGv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}]},["aQL8O","2SOlF"], null, "parcelRequire94c2")

//# sourceMappingURL=ScatterChart.6a8eb7c1.js.map
