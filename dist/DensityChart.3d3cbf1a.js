...
},{"f11b6b8f6a1f6f0b":"786KC","f490fb404efab291":"1dldy"}],"3an3A":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "cc2c9d313d3cbf1a";
"use strict";
...
},{}],"cBz8K":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$64aa = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$64aa.prelude(module);
...
function DensityChart(props) {
        ...
        const filters = [
            {
                ...
                operation: 'range',
                values: [
                    (0, _utils.numFixed)(scales.current.x.invert(x0)),
                    (0, _utils.numFixed)(scales.current.x.invert(x1))
                ]
            },
            {
                id: `${props.id}_y`,
                ...
                operation: 'range',
                values: [
                    (0, _utils.numFixed)(scales.current.y.invert(y1)),
                    (0, _utils.numFixed)(scales.current.y.invert(y0))
                ]
            }
        ];
    ...
    (0, _react.useEffect)(()=>{
        setTimeout(()=>{
            ...
            svg.current = _d3.select(self.current).append('svg').attr('width', rect.width).attr('height', rect.height).append('g').attr('transform', `translate(${margin.left},${margin.top})`);
            const paddingPercent = 0.1; // Adjust the percentage of padding as needed
            const domainExtentX = _d3.extent(props.data, (d)=>d[props.fields.x]);
            const domainPaddingX = (domainExtentX[1] - domainExtentX[0]) * paddingPercent;
            const domainExtentY = _d3.extent(props.data, (d)=>d[props.fields.y]);
            ...
            svg.current.append('g').attr('transform', `translate(0,${innerHeight})`).call(_d3.axisBottom(scales.current.x));
            svg.current.append('g').call(_d3.axisLeft(scales.current.y));
            const getCurrentMouseClickPosition = ()=>{
                const rec = svg.current.select('.overlay').node();
                const mouseX = _d3.event.sourceEvent.clientX - rec.getBoundingClientRect().x;
                const mouseY = _d3.event.sourceEvent.clientY - rec.getBoundingClientRect().y;
                return [
                    mouseX,
                    mouseY
                ];
            };
            const brush = _d3.brush().extent([
                [
                    0,
                    0
                ],
    ...
    (0, _react.useEffect)(()=>{
        setTimeout(()=>{
            ...
            const color = _d3.scaleLinear().domain([
                0,
                k
            ]).range([
                'white',
            ...
            const densityData = _d3.contourDensity().x((d)=>scales.current.x(d[props.fields.x])).y((d)=>scales.current.y(d[props.fields.y])).size([
                innerWidth,
                innerHeight
            ]).bandwidth(20)(data);
            svg.current.select('#draw_area').remove('g');
            svg.current.insert('g', 'g').attr('id', 'draw_area').selectAll('path').data(densityData).enter().append('path').attr('d', _d3.geoPath()).attr('fill', (d)=>color(d.value));
        }, 100);
    }, [
        props.layout,
        props.filters,
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        fileName: "source/components/VisualTools/Chart/DensityChart.js",
        lineNumber: 170,
        columnNumber: 10
    }, this);
}
_s(DensityChart, "kXeVkuhBCqwrTg3GDdVMByl6iHI=");
_c = DensityChart;
...
var _c;
$RefreshReg$(_c, "DensityChart");

  $parcel$ReactRefreshHelpers$64aa.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","d3":"iUtZE","prop-types":"7wKI2","../../../common/utils":"rzfGv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}]},["aQL8O","3an3A"], null, "parcelRequire94c2")

//# sourceMappingURL=DensityChart.3d3cbf1a.js.map
