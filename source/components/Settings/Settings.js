...
function Settings() {
  ...
  const APISubmit = () => {
    ...
    const apiUrl = `http://127.0.0.1:5000/getBins?Sdoh_TableName=${sdohTable}&Omop_TableName=${omopTable}&Concept_Code=${conceptCode}&Concept_Name=${conceptName}&Concept_Type=${conceptTypeValue}&Count_Type=${selectedCountType}&drug-route=${routesQueryParam}&value_as_number=${rangeValue}`;
